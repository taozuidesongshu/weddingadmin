<template>
  <div>
    ...
    <el-table
      ...
      max-height="1000"
    >
      <el-table-column prop="projectname" label="工程名称" sortable></el-table-column>
      <el-table-column prop="floor" label="层数" sortable></el-table-column>
      <el-table-column prop="area" label="面积" sortable></el-table-column>
      <el-table-column prop="address" label="工程地址"></el-table-column>
      <el-table-column prop="qualityname1" label="质量安全监督员1"></el-table-column>
      <el-table-column prop="qualityname2" label="质量安全监督员2"></el-table-column>
      <el-table-column prop="qualityname3" label="质量安全监督员3"></el-table-column>
      <el-table-column prop="qualityname4" label="质量安全监督员4"></el-table-column>
      <el-table-column prop="qualityname5" label="质量安全监督员5"></el-table-column>
      <el-table-column prop="putupsunit" label="建设单位"></el-table-column>
      <el-table-column prop="putupsmana" label="建设单位负责人"></el-table-column>
      <el-table-column prop="constructionunit" label="施工单位"></el-table-column>
      <el-table-column prop="constructionmana" label="施工单位负责人"></el-table-column>
      <el-table-column prop="designunit" label="设计单位"></el-table-column>
      <el-table-column prop="designmana" label="设计单位负责人"></el-table-column>
      <el-table-column prop="supervisionunit" label="监理单位"></el-table-column>
      <el-table-column prop="supervisionmana" label="监理单位负责人"></el-table-column>
      <el-table-column prop="surveyunit" label="勘察单位"></el-table-column>
      <el-table-column prop="surveymana" label="勘察单位负责人"></el-table-column>
      <!-- 一下是详细 -->
      <el-table-column label="报监手续" width="150">
        <template slot-scope="scope">
          <div>是1/0否:{{scope.row.reportsupervisorradio}}</div>
          <div>时间:{{scope.row.reportsupervisortimm|formatDate}}</div>
          <div>证号:{{scope.row.reportsupervisorcertificate}}</div>
          <div>备注:{{scope.row.reportsupervisorremarks}}</div>
        </template>
      </el-table-column>
      <el-table-column label="施工许可证" width="150">
        <template slot-scope="scope">
          <div>是1/0否:{{scope.row.licenseradio}}</div>
          <div>时间:{{scope.row.licensetimm|formatDate}}</div>
          <div>证号:{{scope.row.licensecertificate}}</div>
          <div>备注:{{scope.row.licenseremarks}}</div>
        </template>
      </el-table-column>
      <el-table-column label="文明工地创建" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="基础验收" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="安全生产达标情况" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="机械备案" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="扬尘挂牌情况" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="主体检测" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="主体验收" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="分户验收" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="竣工验收" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="竣工备案" width="150">
        <template slot-scope="scope">
...
export default {
      ...
      this.$axios({
        ...
        .then(res => {
          if (res.data.status == 1) {
            ...
            this.$message("失败" + res.data.message);
          }
        })
        .catch(err => {
          this.$message("失败" + err);
  ...
  mounted: function() {
    this.$axios({
      method: "get",
      url: `${uapi}/index.php/Home/Api/unportect`,
      params: {
        user_id: this.$store.state.user
      }
    })
      .then(res => {
        if (res.data.status == 1) {
          ...
          this.$message({
            message: "获取信息失败" + res.data.message,
            type: "success"
          });
        }
      })
